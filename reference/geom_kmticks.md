...
`geom_kmticks` understands the following aesthetics (required aesthetics
are in bold):

- **`x`** The survival/censoring times. This is automatically mapped by
  [`stat_kmticks()`](https://smouksassi.github.io/ggquickeda/reference/stat_kmticks.md)

- **`y`** The survival probability estimates. This is automatically
  mapped by
  [`stat_kmticks()`](https://smouksassi.github.io/ggquickeda/reference/stat_kmticks.md)
...
[stat_kmticks](https://smouksassi.github.io/ggquickeda/reference/stat_kmticks.md)
see that documentation for more options to control the underlying
