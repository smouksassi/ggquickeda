...
- **Samer Mouksassi**. Author, maintainer.
  [](https://orcid.org/https://orcid.org/0000-0002-7152-6654)

- **Dean Attali**. Author.

- **James Craig**. Author.  
  implemented bookmarking and created pkgdown website

- **Benjamin Rich**. Author.  
  provided summary stats tables table1 tab code

- **Michael Sachs**. Author.  
  provided ggkm initial code
