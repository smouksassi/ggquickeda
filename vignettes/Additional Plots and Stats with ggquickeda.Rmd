...
![cut a continuous variable to categorical](../img/intro_7.png){width=100%}

* Go to **Median PIs (?)** and select Median/PI and then you this get this plot:

![MedianPI](../img/intro_8.png){width=100%}
...
![MedianPI](../img/intro_9.png){width=100%}
...
![MedianPI](../img/intro_10.png){width=100%}
...
![MedianPI](../img/intro_12.png){width=100%}

* Click on the **Descriptive Stats** Tab

![MedianPI](../img/intro_11.png){width=100%}


Remove all y variable(s) keeping Age as x variable gives:

![MedianPI](../img/intro_13.png){width=100%}

Then selecting Weight as x variable gives:

![MedianPI](../img/intro_14.png){width=100%}

As an exercise Pplay with the options in the **Histograms/Density/Bar** to reproduce these plots.