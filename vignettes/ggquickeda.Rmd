...
library(ggquickeda)
```
Let us start by lauching the app `run_ggquickeda()` and clicking on use sample_data:
...
![select sample_df.csv](../img/intro_1.png){width=100%}
...
![select sample_df.csv](../img/intro_2.png){width=100%}
...
![select sample_df.csv](../img/intro_3.png){width=100%}
While we are on this tab let us map Color By: and Column Split: to Gender:
![select sample_df.csv](../img/intro_4.png){width=100%}
Now we want to add a loess trend line:
* Go to  **Smooth/Linear/Logistic Regressions (?)** and click on the Smooth radio button:

![select sample_df.csv](../img/intro_5.png){width=100%}
...
![select sample_df.csv](../img/intro_6.png){width=100%}
